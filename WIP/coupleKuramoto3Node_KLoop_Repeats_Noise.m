...
for om = 1:3
    ...
    [PLV dRPvar MsKappa LHat LVar RPvar] = coupleKuramoto3Node_KLoop_Noise(Klist,sigvar)
...
for om = 1:3
    ...
    if om==3; legend(dh(1,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2))}); end %,sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
    ...
    if om==3; legend(dh(2,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2))}); end %,sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
    ...
    if om==3; legend(dh(3,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2))}); end %,sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
    ...
    if om==3; legend(dh(4,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2))}); end %,sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
    ...
    if om==3; legend(dh(5,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2))}); end %,sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
    ...
    if om==3; legend(dh(6,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2))}); end %,sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
end
