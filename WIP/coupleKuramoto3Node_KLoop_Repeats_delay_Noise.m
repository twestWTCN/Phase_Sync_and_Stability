...
for om = 1:3
    ...
    xlabel('Coupling (log K)'); ylabel('PLV'); xlim(Klim)
    if om==3; legend(dh(1,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2)),sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
    ...
    xlabel('Coupling (log K)'); ylabel('std d\Delta\phi/dt'); xlim(Klim)
    if om==3; legend(dh(2,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2)),sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
    ...
    xlabel('Coupling (log K)'); ylabel('stable:unstable'); xlim(Klim)
    if om==3; legend(dh(3,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2)),sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
    ...
    xlabel('Coupling (log K)'); ylabel('mean log Length'); xlim(Klim)
    if om==3; legend(dh(4,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2)),sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
    ...
    xlabel('Coupling (log K)'); ylabel('std log Length'); xlim(Klim)
    if om==3; legend(dh(5,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2)),sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
    ...
    xlabel('Coupling (log K)'); ylabel('std \Delta\phi'); xlim(Klim)
    if om==3; legend(dh(6,:),{sprintf('\\sigma %.2f',sigvar(1)) ,sprintf('\\sigma %.2f',sigvar(2)),sprintf('\\sigma %.2f',sigvar(3))},'Location','best'); end
end
